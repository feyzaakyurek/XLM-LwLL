...
echo "Exp name     : compnmt-en-so-4g" >> $LOG_STDOUT
...
--dump_path ./dumped/ \
--reload_model 'dumped/unsupMT_soen/8237934/best-valid_so-en_mt_bleu.pth,dumped/unsupMT_soen/8237934/best-valid_so-en_mt_bleu.pth' \
